            ...
            <div className="space-y-4">
                <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    <div className="sm:col-span-full">
                        <label htmlFor="api-key" className="block text-sm font-medium leading-6 text-gray-900">API Key <a href="#" className="text-indigo-600 text-xs hover:underline ml-2">Lấy Gemini API Key</a></label>
                        <div className="mt-2">
